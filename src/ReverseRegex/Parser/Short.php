...
class Short implements StrategyInterface
{
    ...
    public function convertDotToRange(LiteralScope $head, Scope $result, Lexer $lexer)
    {
        for($i = 0; $i <= 127; $i++) {
    ...
    public function convertDigitToRange(LiteralScope $head, Scope $result, Lexer $lexer)
    {
    ...
    public function convertWordToRange(LiteralScope $head, Scope $result, Lexer $lexer)
    {
    ...
    public function convertWhiteSpaceToRange(LiteralScope $head, Scope $result, Lexer $lexer)
    {
